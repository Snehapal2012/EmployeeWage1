package com.employeewage;
    ...
    public class UC14_EmployeeWageBuilder implements IEmployeeWage{
        ...
        public UC14_EmployeeWageBuilder() {
        ...
        public static void main(String[] args) {
            ...
            IEmployeeWage employeeWageBuilder = new UC14_EmployeeWageBuilder();
            ((UC14_EmployeeWageBuilder) employeeWageBuilder).addCompanyInfo("Infosys", 150, 2, 10);
            ((UC14_EmployeeWageBuilder) employeeWageBuilder).addCompanyInfo("TCS" , 200, 3, 10);
            ((UC14_EmployeeWageBuilder) employeeWageBuilder).addCompanyInfo("Accenture", 100, 4, 12);
            ((UC14_EmployeeWageBuilder) employeeWageBuilder).addCompanyInfo("Jio", 180, 3, 15);
            ((UC14_EmployeeWageBuilder) employeeWageBuilder).addCompanyInfo("Airtel", 160, 4, 14);
            ((UC14_EmployeeWageBuilder) employeeWageBuilder).computeEmpWage();
        }
    }
